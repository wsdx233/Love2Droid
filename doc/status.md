...
- 已提供中英文双文件 README、五张真实界面截图与统一应用品牌；normal 应用使用 Android 抱着 LÖVE 的矢量图标，支持 API 26+ 自适应、API 33+ 单色主题和 API 23+ 兼容图标。构图及来源分别见 [design.md](design.md#应用品牌与启动图标) 与 [reference.md](reference.md#应用品牌与-readme-素材)，桌面裁切与主题图标仍需真机确认。
